...
route(Departing,Arriving,Visited,DepartureTime,ArrivalTime,Flights,TotalCost):-
  flight(Departing,Arriving,DepartureTime,ArrivalTime,TotalCost),
	...
	%setting list for Flights
  	Flights=[Departing,Arriving].

% Recursively Searching through the route
route(Departing,Arriving,Visited,DepartureTime,ArrivalTime,Flights,TotalCost):-
  flight(Departing,ConnectedFlight,DepartureTime,ConnectedArrival,Initial),
  	\+ member(ConnectedFlight,Visited), append(Visited,[Departing,ConnectedFlight],X),
  route(ConnectedFlight,Arriving,X,ConnectedDeparture, ArrivalTime,TailListFlight,TailListCost),
  % quicksorting
  	ConnectedArrival@<ConnectedDeparture, 
  Flights=[Departing|TailListFlight],
  %calculate totalcost of the route taken
  TotalCost is Initial+TailListCost.